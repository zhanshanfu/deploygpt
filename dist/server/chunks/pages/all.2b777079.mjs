/* empty css                           */import { c as createAstro, a as createComponent$1, r as renderTemplate, b as addAttribute, d as renderHead, e as renderSlot, m as maybeRenderHead, f as renderComponent, _ as __astro_tag_component__ } from '../astro.935d42a1.mjs';
import 'html-escaper';
...
}, "D:/Other/github/chatgpt-demo/src/layouts/Layout.astro");
...
}, "D:/Other/github/chatgpt-demo/src/components/Logo.astro");
...
}, "D:/Other/github/chatgpt-demo/src/components/Themetoggle.astro");
...
}, "D:/Other/github/chatgpt-demo/src/components/Header.astro");
...
}, "D:/Other/github/chatgpt-demo/src/components/Footer.astro");
...
const _tmpl$$1 = ["<div", "><div class=\"flex items-center gap-1 op-50 dark:op-60\"><!--#-->", "<!--/--><span>System Role:</span></div><div class=\"mt-1\">", "</div></div>"],
  _tmpl$2$1 = ["<span", " class=\"inline-flex items-center justify-center gap-1 text-sm bg-slate/20 px-2 py-1 rounded-md transition-colors cursor-pointer hover:bg-slate/50\"><!--#-->", "<!--/--><span>Add System Role</span></span>"],
  _tmpl$3$1 = ["<div", "><div class=\"flex items-center gap-1 op-50 dark:op-60\"><!--#-->", "<!--/--><span>System Role:</span></div><p class=\"my-2 leading-normal text-sm op-50 dark:op-60\">Gently instruct the assistant and set the behavior of the assistant.</p><div><textarea placeholder=\"You are a helpful assistant, answer as concisely as possible....\" autocomplete=\"off\" autofocus rows=\"3\" w-full px-3 py-3 my-1 min-h-12 max-h-36 rounded-sm bg-slate bg-op-15 focus:bg-op-20 focus:ring-0 focus:outline-none placeholder:op-50 dark=\"placeholder:op-30\" overflow-hidden resize-none scroll-pa-8px></textarea></div><button h-12 px-4 py-2 bg-slate bg-op-15 hover:bg-op-20 rounded-sm>Set</button></div>"],
...
const _tmpl$ = ["<div", " class=\"", "\"><textarea", " placeholder=\"Enter something...\" autocomplete=\"off\" autofocus rows=\"1\" w-full px-3 py-3 min-h-12 max-h-36 rounded-sm bg-slate bg-op-15 resize-none focus:bg-op-20 focus:ring-0 focus:outline-none placeholder:op-50 dark=\"placeholder:op-30\" scroll-pa-8px></textarea><button", " h-12 px-4 py-2 bg-slate bg-op-15 hover:bg-op-20 rounded-sm>Send</button><button title=\"Clear\"", " h-12 px-4 py-2 bg-slate bg-op-15 hover:bg-op-20 rounded-sm>", "</button></div>"],
...
const $$Index = createComponent$1(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "ChatGPT API Demo" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main>
    ...
    ${renderComponent($$result2, "Generator", _arrow_function, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/Other/github/chatgpt-demo/src/components/Generator", "client:component-export": "default" })}
    ${renderComponent($$result2, "Footer", $$Footer, {})}
  </main>` })}`;
}, "D:/Other/github/chatgpt-demo/src/pages/index.astro");

const $$file$1 = "D:/Other/github/chatgpt-demo/src/pages/index.astro";
const $$url$1 = "";
...
const $$Password = createComponent$1(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Password Protection", "class": "astro-MRWAQY26" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="h-screen flex flex-col items-center justify-center astro-MRWAQY26">
    <div class="op-30 astro-MRWAQY26">Please input password</div>
    <div id="input_container" class="flex mt-4 astro-MRWAQY26">
      <input id="password_input" type="password" class="px-4 py-3 h-12 rounded-sm bg-slate bg-op-15 focus:bg-op-20 focus:ring-0 focus:outline-none astro-MRWAQY26">
      <div id="submit" class="flex items-center justify-center h-12 w-12 bg-slate cursor-pointer bg-op-20 hover:bg-op-50 astro-MRWAQY26">
...
`;
}, "D:/Other/github/chatgpt-demo/src/pages/password.astro");

const $$file = "D:/Other/github/chatgpt-demo/src/pages/password.astro";
const $$url = "/password";
...
const apiKey = "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";
const baseUrl = "https://api.llke.cc/openai".trim().replace(/\/$/, "");
...
const post$1 = async (context) => {
  ...
  const response = await fetch$1(`${baseUrl}/v1/chat/completions`, initOptions);
